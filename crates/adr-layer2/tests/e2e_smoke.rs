...
fn e2e_resolve_then_execute_noop() {
	...
	let graph = AdrGraph {		
		nodes: vec![
			adr_layer2::resolver::AdrNodeMeta { id: id1, effect: adr_core::Effect::None, dependencies: vec![], trust_tier: None, },
			adr_layer2::resolver::AdrNodeMeta { id: id2, effect: adr_core::Effect::None, dependencies: vec![], trust_tier: None, },
		],
	};
